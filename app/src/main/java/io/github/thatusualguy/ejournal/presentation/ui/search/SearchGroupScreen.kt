...
import io.github.thatusualguy.ejournal.presentation.layout.GroupEntry
...
fun SearchGroupScreen(
    ...
    val viewModel = viewModel(modelClass = SearchGroupsViewModel::class.java)
    ...
    StudentScaffoldDrawer(
        ...
        Surface(
            ...
            SlideUpPanelLayout(
                panelHeader = "Найдено ${state.groups.size} групп",
                content = {
                    Column(
                        modifier = Modifier
                            .fillMaxSize()
...
//                            .fillMaxWidth()
                ...
                panelContent = {
                    ...
                    LazyColumn(
                        ...
                        content = {
                            items(state.groups) {
                                GroupEntry(item = it, navController = navController)
                            }
                        })
                }
            )
